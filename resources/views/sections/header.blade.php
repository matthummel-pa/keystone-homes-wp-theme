...
<a href="#main" class="skip-link">{{ __('Skip to main content', 'keystone-homes') }}</a>
<header class="site-header">
  <div class="header-inner">
    ...
    <nav class="main-nav" aria-label="{{ esc_attr__('Primary', 'keystone-homes') }}">
      <ul>
        @foreach ($nav as $item)
          <li>
    ...
    <button type="button" class="hamburger" id="hamburgerBtn" aria-expanded="false" aria-controls="mobileNav" aria-label="{{ esc_attr__('Open menu', 'keystone-homes') }}">
...
<nav class="mobile-nav" id="mobileNav" aria-label="{{ esc_attr__('Site menu', 'keystone-homes') }}" role="dialog" aria-modal="true" aria-hidden="true" hidden>
  <div class="mobile-nav-head">
    <div class="mobile-nav-brand">
      ...
      <div>
        <p class="mobile-nav-kicker">{{ __('Browse', 'keystone-homes') }}</p>
        <p class="mobile-nav-title">{{ $brand }}</p>
      </div>
    </div>
    <button type="button" class="mobile-nav-close" id="mobileNavClose" aria-label="{{ esc_attr__('Close menu', 'keystone-homes') }}">
  ...
  <div class="mobile-nav-foot">
    <a class="header-phone" href="{{ esc_url($phoneHref) }}">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.8 19.8 0 01-8.63-3.07 19.5 19.5 0 01-6-6A19.8 19.8 0 012.12 4.18 2 2 0 014.11 2h3a2 2 0 012 1.72c.13.96.36 1.9.7 2.81a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0122 16.92z"/></svg>
      {{ sprintf(__('Call %s', 'keystone-homes'), $phone) }}
    </a>
